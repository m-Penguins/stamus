...
export default {
  ...
  setup() {
    ...
    const bigImage = "images/big-images/business.png";
    ...
    useHead({
      title: "Лечение по ДМС в стоматологии Стамус в Краснодаре",
      meta: [
        {
          name: "twitter:title",
          content: "Лечение по ДМС в стоматологии Стамус в Краснодаре",
        },
        {
          property: "og:title",
          content: "Лечение по ДМС в стоматологии Стамус в Краснодаре",
