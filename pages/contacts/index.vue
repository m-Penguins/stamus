...
useHead({
  title: "Контакты стоматологической клиники Стамус",
  meta: [
    {
      name: "twitter:title",
      content: "Контакты стоматологической клиники Стамус",
    },
    {
      property: "og:title",
      content: "Контакты стоматологической клиники Стамус",
    },
    {
      name: "description",
      content:
        "Контакты стоматологической клиники Стамус: номер телефона, электронная почта, ссылки на мессенджеры и адреса стоматологий на карте.",
    },
    {
