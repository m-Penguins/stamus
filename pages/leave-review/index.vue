...
const stepHeader = [
  ...
  {
    title: "Оцените ваш прием",
    text: "Выберите пункт, который больше всего описывает процесс приема у врача",
  },
  {
...
useHead({
  title: "Оставить отзыв о клинике Стамус",
  meta: [
    {
      name: "twitter:title",
      content: "Оставить отзыв о клинике Стамус",
    },
    {
      property: "og:title",
      content: "Оставить отзыв о клинике Стамус",
    },
    {
      name: "description",
      content:
        "Оставьте отзыв о стоматологической клинике Стамус. Стоматология является одним из лидеров Краснодарского края по количеству отзывов на независимых порталах.",
    },
    {
