<template>
  <NuxtLink class="service-card" :to="review.link" target="_blank">
      <div>
        ...
        <div class="ratings">
          <div class="stars" >
            <svg v-for="item in new Array(6)" :key="item" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <img class="service-icon" :src="assetsStore.useAsset(`images/icons/${review.image}`)" alt="">
  </NuxtLink>
</template>
