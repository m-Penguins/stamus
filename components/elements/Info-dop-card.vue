    ...
    <div class="accordion-content">
      <div v-if="item.id === 1">
        <div class="accordion-content-text">
          <div class="accordion-content-id1-box">
            ...
            <p>{{ item.text6 }}</p>
            <p>{{ item.text7 }}</p>
            <NuxtLink :to="'#'" class="header-nav-item link-info-doc">{{ item.text8 }}</NuxtLink>
            ...
            <p>{{ item.text14 }}</p>
            <p>{{ item.text15 }}</p>
            <NuxtLink :to="'#'" class="header-nav-item link-info-doc">{{ item.text16 }}</NuxtLink>
            ...
            <p>{{ item.text25 }}</p>
            <p>{{ item.text26 }}</p>
            <NuxtLink :to="'#'" class="header-nav-item link-info-doc">{{ item.text27 }}</NuxtLink>
      ...
      <div v-if="item.id === 2">
        <div class="accordion-content-text accordion-content-id1-box">
          <p class="accordion-content-id1-subtitle">Федеральный закон от 21.11.2011 N 323-ФЗ <a href="http://www.krdsp2.ru/patsientu/normativno---pravovye-dokumenty/?roistat_visit=293636">«Об основах охраны здоровья граждан в Российской Федерации»</a></p>
      ...
      <div v-if="item.id === 3">
        <div class="accordion-content-text accordion-content-id1-box">
          <NuxtLink :to="'#'" class="header-nav-item link-info-doc">{{ item.text }}</NuxtLink>
      ...
      <div v-if="item.id === 7">
        <div>
          ...
          <div class="accordion-content-inputs">
            ...
            <elements-checkbox label="Проходил лечение в 2020 г" v-model="isChecked"/>
            <elements-checkbox label="Проходил лечение в 2021 г" v-model="isChecked"/>
            <elements-checkbox label="Проходил лечение в 2022 г" v-model="isChecked"/>
            <elements-checkbox label="Проходил лечение в 2023 г" v-model="isChecked"/>
            <elements-select :options="optionsData" :default="'Получаю справку'" class="select"/>
            <elements-input-base placeholder="ФИО пациента" class="popup-form-input"/>
            <elements-select :options="optionsDoc" :default="'Выберите как хотите получить справку'" class="select"/>
            <elements-input-base placeholder="Адрес электронной почты" class="popup-form-input"/>
            <div>
              <elements-button-base title="Отправить" class="form-btn"/>
