        ...
        <div class="banner-container">
          ...
          <div class="banner-box">
            ...
            <NuxtLink
              ...
              class="link-wrapper"
            >
              <p :style="{color: banner?.text_color}" class="text text-white">{{ banner?.link_text }}</p>
              <div>
                <svg
                  width="18"
                  height="9"
          ...
          <div class="banner-images">
            <NuxtImg
              ...
              provider="strapi"
              :alt="banner?.image?.data?.attributes?.alternativeText ?? 'image'"
