<template>
  ...
  <div class="doc-block-container">
    <a :href="baseUrl + file?.attributes?.url" v-for="file in files" target="_blank" class="doc-card">
      <div class="doc-card-container">
        <div class="doc-card-box">
          <img
              src="../../assets/images/icons/icon-documentation.svg"
              alt="icon"
          />
        </div>
        <div class="doc-card-box-text">
          <div class="doc-card-title">{{ file?.attributes?.name }}</div>
          <div class="doc-card-text">{{ file?.attributes?.caption }}</div>
        </div>
      </div>
